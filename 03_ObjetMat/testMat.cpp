...
int main()
 {
    ...
    cout << "Refcount : " << ImgSource.u->refcount << " Adresse du premier pixel: " << hex << (int)ImgSource.data << endl;
    ...
    cout << "Refcount: " << ImgSource.u->refcount << " Adresse du premier pixel: " << hex << (int)ImgDest1.data << endl;
    waitKey(0);

    Mat ImgDest2 = ImgDest1;   // Opérateur d’assignation. copie uniquement de l'entête
    imshow("Img Destination 2", ImgDest1);
    cout << "Refcount: " << ImgSource.u->refcount << " Adresse du premier pixel: " << hex << (int)ImgDest2.data << endl;
    waitKey(0);
    ...
    cout << "Refcount: " << ImgSource.u->refcount << " Adresse du premier pixel: " << hex << (int)ImgDest3.data << endl;
    waitKey(0);
